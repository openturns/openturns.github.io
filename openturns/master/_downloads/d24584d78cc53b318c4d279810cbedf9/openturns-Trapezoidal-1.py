...
if "Trapezoidal" == "Bernoulli":
    ...
    if hasattr(ot, "Trapezoidal"):
        distribution = ot.Trapezoidal()
    else:
        distribution = otexp.Trapezoidal()
