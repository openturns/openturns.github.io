...
if "Bernoulli" == "Bernoulli":
    ...
    if hasattr(ot, "Bernoulli"):
        distribution = ot.Bernoulli()
    else:
        distribution = otexp.Bernoulli()
