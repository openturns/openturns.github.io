...
if "Histogram" == "Bernoulli":
    ...
    if hasattr(ot, "Histogram"):
        distribution = ot.Histogram()
    else:
        distribution = otexp.Histogram()
