...
if "LogNormal" == "Bernoulli":
    ...
    if hasattr(ot, "LogNormal"):
        distribution = ot.LogNormal()
    else:
        distribution = otexp.LogNormal()
