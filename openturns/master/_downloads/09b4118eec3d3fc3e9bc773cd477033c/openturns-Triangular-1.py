...
if "Triangular" == "Bernoulli":
    ...
    if hasattr(ot, "Triangular"):
        distribution = ot.Triangular()
    else:
        distribution = otexp.Triangular()
