...
if "Exponential" == "Bernoulli":
    ...
    if hasattr(ot, "Exponential"):
        distribution = ot.Exponential()
    else:
        distribution = otexp.Exponential()
