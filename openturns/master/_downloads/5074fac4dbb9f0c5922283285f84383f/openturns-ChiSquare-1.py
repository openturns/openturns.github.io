...
if "ChiSquare" == "Bernoulli":
    ...
    if hasattr(ot, "ChiSquare"):
        distribution = ot.ChiSquare()
    else:
        distribution = otexp.ChiSquare()
