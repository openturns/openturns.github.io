...
if "InverseNormal" == "Bernoulli":
...
elif "InverseNormal" == "LinearCombinationDistribution":
...
elif "InverseNormal" == "FiniteDiscreteDistribution":
    ...
    if hasattr(ot, "InverseNormal"):
        distribution = ot.InverseNormal()
    else:
        distribution = otexp.InverseNormal()
