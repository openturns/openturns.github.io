...
if "Multinomial" == "Bernoulli":
    ...
    if hasattr(ot, "Multinomial"):
        distribution = ot.Multinomial()
    else:
        distribution = otexp.Multinomial()
