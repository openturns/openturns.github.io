...
if "Geometric" == "Bernoulli":
    ...
    if hasattr(ot, "Geometric"):
        distribution = ot.Geometric()
    else:
        distribution = otexp.Geometric()
