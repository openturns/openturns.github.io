...
elif ot.Exponential().__class__.__name__ == 'Hypergeometric':
...
elif ot.Exponential().__class__.__name__ == 'SmoothedUniform':
...
elif ot.Exponential().__class__.__name__ == 'Normal':
