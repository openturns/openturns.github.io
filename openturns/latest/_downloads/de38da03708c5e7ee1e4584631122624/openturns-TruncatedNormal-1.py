...
elif ot.TruncatedNormal().__class__.__name__ == 'Hypergeometric':
...
elif ot.TruncatedNormal().__class__.__name__ == 'SmoothedUniform':
...
elif ot.TruncatedNormal().__class__.__name__ == 'Normal':
