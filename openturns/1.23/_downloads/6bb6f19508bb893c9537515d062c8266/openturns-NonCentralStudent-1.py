...
elif ot.NonCentralStudent().__class__.__name__ == 'Hypergeometric':
...
elif ot.NonCentralStudent().__class__.__name__ == 'SmoothedUniform':
...
elif ot.NonCentralStudent().__class__.__name__ == 'Normal':
