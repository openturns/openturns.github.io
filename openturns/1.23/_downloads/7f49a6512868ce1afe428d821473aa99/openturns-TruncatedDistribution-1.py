...
elif ot.TruncatedDistribution().__class__.__name__ == 'Hypergeometric':
...
elif ot.TruncatedDistribution().__class__.__name__ == 'SmoothedUniform':
...
elif ot.TruncatedDistribution().__class__.__name__ == 'Normal':
