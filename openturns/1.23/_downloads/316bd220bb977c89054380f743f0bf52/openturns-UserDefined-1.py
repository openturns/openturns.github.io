...
elif ot.UserDefined().__class__.__name__ == 'Hypergeometric':
...
elif ot.UserDefined().__class__.__name__ == 'SmoothedUniform':
...
elif ot.UserDefined().__class__.__name__ == 'Normal':
