...
if ot.JointDistribution().__class__.__name__ == 'BlockIndependentCopula':
    distribution = ot.BlockIndependentCopula([ot.ClaytonCopula(2.0), ot.GumbelCopula(3.0)])
elif ot.JointDistribution().__class__.__name__ == 'JointDistribution':
...
elif ot.JointDistribution().__class__.__name__ == 'BlockIndependentDistribution':
