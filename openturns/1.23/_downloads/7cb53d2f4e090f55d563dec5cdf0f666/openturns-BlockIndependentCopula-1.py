...
if ot.BlockIndependentCopula().__class__.__name__ == 'BlockIndependentCopula':
    distribution = ot.BlockIndependentCopula([ot.ClaytonCopula(2.0), ot.GumbelCopula(3.0)])
elif ot.BlockIndependentCopula().__class__.__name__ == 'JointDistribution':
...
elif ot.BlockIndependentCopula().__class__.__name__ == 'BlockIndependentDistribution':
    ...
    distribution = ot.BlockIndependentCopula()
