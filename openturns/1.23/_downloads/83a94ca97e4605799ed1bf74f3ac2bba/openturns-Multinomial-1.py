...
elif ot.Multinomial().__class__.__name__ == 'Hypergeometric':
...
elif ot.Multinomial().__class__.__name__ == 'SmoothedUniform':
...
elif ot.Multinomial().__class__.__name__ == 'Normal':
