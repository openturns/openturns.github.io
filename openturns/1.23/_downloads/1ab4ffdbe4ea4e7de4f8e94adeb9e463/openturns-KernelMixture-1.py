...
elif ot.KernelMixture().__class__.__name__ == 'Hypergeometric':
...
elif ot.KernelMixture().__class__.__name__ == 'SmoothedUniform':
...
elif ot.KernelMixture().__class__.__name__ == 'Normal':
