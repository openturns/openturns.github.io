...
if "FarlieGumbelMorgensternCopula" == "EmpiricalBernsteinCopula":
    sample = ot.Dirichlet([1.0, 2.0, 3.0]).getSample(100)
    copula = ot.EmpiricalBernsteinCopula(sample, 4)
elif "FarlieGumbelMorgensternCopula" == "ExtremeValueCopula":
    copula = ot.ExtremeValueCopula(ot.SymbolicFunction("t", "t^3/2-t/2+1"))
elif "FarlieGumbelMorgensternCopula" == "NormalCopula":
    R = ot.CorrelationMatrix(2)
    R[1, 0] = 0.8
    copula = ot.NormalCopula(R)
elif "FarlieGumbelMorgensternCopula" == "SklarCopula":
