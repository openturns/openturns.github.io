...
.. plot::
    ...
    elif ot.ProductCovarianceModel().__class__.__name__ == 'GeneralizedExponential':
        covarianceModel = ot.GeneralizedExponential([2.0], [3.0], 1.5)
    elif ot.ProductCovarianceModel().__class__.__name__ == 'ProductCovarianceModel':
        amplitude = [1.0]
        scale1 = [4.0]
        scale2 = [4.0]
    ...
    elif ot.ProductCovarianceModel().__class__.__name__ == 'StationaryFunctionalCovarianceModel':
