...
.. plot::
    ...
    if ot.BlockIndependentDistribution().__class__.__name__ == 'ComposedCopula':
        distribution = ot.ComposedCopula([ot.ClaytonCopula(2.0), ot.GumbelCopula(3.0)])
    elif ot.BlockIndependentDistribution().__class__.__name__ == 'ComposedDistribution':
    ...
    elif ot.BlockIndependentDistribution().__class__.__name__ == 'BlockIndependentDistribution':
...
.. autoclass:: BlockIndependentDistribution
