...
.. plot::
    ...
    if ot.ComposedCopula().__class__.__name__ == 'ComposedCopula':
        distribution = ot.ComposedCopula([ot.ClaytonCopula(2.0), ot.GumbelCopula(3.0)])
    elif ot.ComposedCopula().__class__.__name__ == 'ComposedDistribution':
    ...
    elif ot.ComposedCopula().__class__.__name__ == 'BlockIndependentDistribution':
        ...
        distribution = ot.ComposedCopula()
