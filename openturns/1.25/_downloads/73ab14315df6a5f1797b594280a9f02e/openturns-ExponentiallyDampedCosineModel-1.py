...
elif "ExponentiallyDampedCosineModel" == "ProductCovarianceModel":
    amplitude = [1.0]
    scale1 = [4.0]
    scale2 = [4.0]
...
elif "ExponentiallyDampedCosineModel" == "RankMCovarianceModel":
    variance = [1.0, 2.0]
    basis = ot.LinearBasisFactory().build()
    covarianceModel = ot.RankMCovarianceModel(variance, basis)
elif "ExponentiallyDampedCosineModel" == "StationaryFunctionalCovarianceModel":
