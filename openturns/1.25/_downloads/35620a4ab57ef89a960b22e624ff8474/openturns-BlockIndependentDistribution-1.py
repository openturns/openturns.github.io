...
if "BlockIndependentDistribution" == "BlockIndependentCopula":
    distribution = ot.BlockIndependentCopula([ot.ClaytonCopula(2.0), ot.GumbelCopula(3.0)])
elif "BlockIndependentDistribution" == "JointDistribution":
...
elif "BlockIndependentDistribution" == "BlockIndependentDistribution":
