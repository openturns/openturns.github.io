...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Asymptotic
    Estimator: Saltelli
    /opt/hostedtoolcache/Python/3.9.20/x64/lib/python3.9/site-packages/openturns/viewer.py:282: RuntimeWarning: More than 20 figures have been opened. Figures created through the pyplot interface (`matplotlib.pyplot.figure`) are retained until explicitly closed and may consume too much memory. (To control this warning, see the rcParam `figure.max_open_warning`).
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 18.055 seconds)
